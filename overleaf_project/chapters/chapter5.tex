...
\screenshotplaceholder{Login and registration interface}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\textwidth]{images/job_creation.png}
...
\screenshotplaceholder{Candidate job directory with search filters}

\screenshotplaceholder{Candidate profile editor}
...
\subsection{ATS Scoring Prompt Design}

The quality of AI-generated scores depends critically on the prompt. SmartHire uses a structured prompt that specifies the expected output format, scoring dimensions, and scale:

\begin{lstlisting}[language={}, caption={Simplified ATS scoring prompt template}]
Evaluate the following resume against the job description.
Provide scores on a scale of 0 to 10 for each dimension:
- Skills Match: How well do the candidate's skills
  align with the required skills?
- Experience Relevance: How relevant is the
  candidate's work experience?
- Overall Fit: Composite score considering all factors.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.65\textwidth]{images/ats_scorecard.png}
  \caption{ATS screening card breakdown with candidate evaluation score and technical skills match.}
  \label{fig:ats_scorecard}
\end{figure}
...
\screenshotplaceholder{MCQ examination interface with countdown timer}
...
\screenshotplaceholder{Monaco coding IDE with test results panel}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\textwidth]{images/ai_interview.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\textwidth]{images/pipeline_board.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.92\textwidth]{images/recruiter_dashboard.png}
...
\screenshotplaceholder{Mobile responsive navigation drawer}
